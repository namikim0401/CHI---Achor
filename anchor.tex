...
We iterated across low- and high-fidelity prototypes, incorporating feedback from twelve participants across paper and Figma prototype testing, before implementing a functional version using React, Supabase, and the Google Calendar and Gmail APIs. This paper documents our full design process from needfinding through evaluation and outlines our planned next iteration.
\end{abstract}
...
For many students and young professionals who experience challenges such as ADHD, anxiety, or depression, the hardest part of completing tasks is often not the work itself, but figuring out where to start. Our needfinding revealed two interconnected barriers: overwhelm from having too much to do and difficulty initiating tasks. One participant had every prerequisite for a task ready for a year—number found, script written, insurance card saved—but still could not begin because the task had no clear starting or ending point. Another had no trouble finishing tasks once he started working, but the mental effort and preparation required often caused him to delay until the last minute. Across participants, scattered obligations across email, calendars, and chats, combined with ambiguous task requirements, made it difficult to determine what to prioritize or do first, increasing feelings of anxiety and overwhelm.
...
\begin{enumerate}
  \item Users can select the apps that they think are distracting. The app button and interfaces of the rest of the apps keep colorful, but the longer the users stay on the distraction apps, the grayer the interfaces and the app buttons become.
